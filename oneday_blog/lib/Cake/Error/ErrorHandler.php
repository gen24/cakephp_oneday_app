 ...
 */
	public static function handleException(Exception $exception) {
		...
		try {
			...
			set_error_handler(Configure::read('Exception.handler')); // Should be using configured ErrorHandler
			Configure::write('Exception.trace', false); // trace is useless here since it's internal
